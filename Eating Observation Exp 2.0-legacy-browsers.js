...
function Instruction__screenRoutineBegin(snapshot) {
  return async function () {
    ...
    Instruction__screenComponents.forEach( function(thisComponent) {
...
function Baseline_trialsLoopBegin(Baseline_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    Baseline_trials.forEach(function() {
...
function Baseline_codeRoutineBegin(snapshot) {
  return async function () {
    ...
    Baseline_codeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Baseline_StroopRoutineBegin(snapshot) {
  return async function () {
    ...
    Baseline_StroopComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Begin_Video_obs_taskRoutineBegin(snapshot) {
  return async function () {
    ...
    Begin_Video_obs_taskComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EO_CODERoutineBegin(snapshot) {
  return async function () {
    ...
    EO_CODEComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function EO_ConditionRoutineBegin(snapshot) {
  return async function () {
    ...
    EO_ConditionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function RemainderRoutineBegin(snapshot) {
  return async function () {
    ...
    RemainderComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function FO_CODERoutineBegin(snapshot) {
  return async function () {
    ...
    FO_CODEComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function FO_ConditionRoutineBegin(snapshot) {
  return async function () {
    ...
    FO_ConditionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NF_CODERoutineBegin(snapshot) {
  return async function () {
    ...
    NF_CODEComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function NF_ConditionRoutineBegin(snapshot) {
  return async function () {
    ...
    NF_ConditionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
